 ...
 *       — Rick Osborne
 *
    Author:- Arijit Shrivastav
    Theory :- Diameter of the graph,
    Explanation:- 1) Do bfs from random node, 2) do bfs again from the farthest found node,
    3) dist[farthest node] is the maximum distant node from any node
    Problem link :- https://www.hackerearth.com/problem/algorithm/agitated-chandan
 */
